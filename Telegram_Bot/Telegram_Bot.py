...
TOKEN = "Enter Your token" #Get from BotFather
...
def main():
    ...
    updater.start_webhook(listen='0.0.0.0', port=PORT, url_path=TOKEN,webhook_url='Enter Webhook_url'+TOKEN)
    #updater.bot.set_webhook('https://b262-141-94-187-157.ngrok.io/' + TOKEN)
